...
public class GlobalExceptionHandler {
    ...
    @ResponseBody
    public R baseExceptionHandler(HttpServletRequest req, CustomException ex) throws Exception {
        return R.error(ex);
    }
    ...
    public R httpMessageNotReadableExceptionHandler(HttpServletRequest req, Exception ex) throws Exception {
        ...
        return R.error(CodeDefined.ERROR_SYNTAX).data(ex.getLocalizedMessage());
    }
